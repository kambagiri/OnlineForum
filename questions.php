  ...
  <body>
    <?php
	 ...
	 $dbname = "onlineforum"; 
	   ...
	   $result = mysql_query("SELECT id, title, description, tags FROM data");
     ...
     while ($row = mysql_fetch_array($result)) 
      {
        $qid[$qcount] = $row["id"];
        $qtitle[$qcount] = $row["title"];
        $qdescription[$qcount] = $row["description"];
        $qtag[$qcount] = $row["tags"];
        $qcount++;
      }
      //echo $qtag[1]; 
    ?>
    ...
    <div id= "topbar">
   	...
   	<div id ="wrapper">
              ...
              <table>
                ...
                <?php 
                   for($i=$qcount-1; $i >= 1; $i--)
                    {  ?>
                          <tr class="qtablerow">
                          <td> <a href="./<?php  echo $i ?>.html" >  <?php echo $qtitle[$i] ?> </a> <br /> <?php echo $qtag[$i]  ?> </td> 
                          </tr>
               <?php } ?> 
        ...
        <div id="sidebar">
          <div class ="ad">
            <iframe src='https://onedrive.live.com/embed?cid=47B79D935AA26504&resid=47B79D935AA26504%21107&authkey=&em=2&wdAr=1.7777777777777777' width='350px' height='221px' frameborder='0'>This is an embedded <a target='_blank' href='http://office.com'>Microsoft Office</a> presentation, powered by <a target='_blank' href='http://office.com/webapps'>Office Online</a>.</iframe>
          </div>
        </div>
